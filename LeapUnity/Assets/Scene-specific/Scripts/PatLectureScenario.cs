...
public class PatLectureScenario : LectureScenario
{
	...
	{		
		...
		if (condition == ConditionType.Affiliative) {
			mapAlign = 0f;
			cameraAlign = 1f;
			gazeCtrl.lEye.inOMR = gazeCtrl.lEye.outOMR = 55f;
			gazeCtrl.rEye.inOMR = gazeCtrl.rEye.outOMR = 55f;
		}
			...
			mapAlign = 1f;
			cameraAlign = 0f;
			gazeCtrl.lEye.inOMR = gazeCtrl.lEye.outOMR = 45f;
			gazeCtrl.rEye.inOMR = gazeCtrl.rEye.outOMR = 45f;
		}
		...
		// Start End. paragraph
		speechCtrl.Speak("PatLectureEnd");
