...
public class DoGestureAction : ScenarioAction
{
    ...
    /// </param>
    public DoGestureAction(GameObject agent, string gesture)
        : base(agent)
    {
...
public class SpeakAction : ScenarioAction
{
    ...
    /// </param>
    public SpeakAction(GameObject agent, string speech)
        : base(agent)
    {
        this.speech = speech;
    ...
    /// </param>
    public SpeakAction(GameObject agent, string speech, SpeechType typeOfSpeech)
        : base(agent)
    {
        this.speech = speech;
    ...
    public SpeakAction(GameObject agent, string speech, SpeechType typeOfSpeech, bool doCog)
        : base(agent)
    {
        this.speech = speech;
        this.typeOfSpeech = typeOfSpeech;
    ...
    /// Type of speech utterance (Question, Answer, or Other)
    /// </param>
    public SpeakAction(GameObject agent, GameObject otherAgent, string speech, SpeechType typeOfSpeech)
        : base(agent)
    {
        this.speech = speech;
        this.typeOfSpeech = typeOfSpeech;
    ...
    public SpeakAction(GameObject agent, GameObject otherAgent, string speech, SpeechType typeOfSpeech, float cogStart, float cogEnd, GazeAversionTarget target)
        : base(agent)
    {
        this.speech = speech;
        this.typeOfSpeech = typeOfSpeech;
...
public class ListenAction : ScenarioAction
{
    ...
    public ListenAction(GameObject agent)
        : base(agent)
    {
    ...
    public ListenAction(GameObject agent, bool open)
        : base(agent)
    {
        listenCtrl = agent.GetComponent<ListenController>();
        openListening = open;
