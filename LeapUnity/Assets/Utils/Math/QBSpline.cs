...
public class QBSpline
{
	...
	/// </summary>
	public void FitToPoints( List<Vector2> data )
	{
		controlPoints.Clear();

		// Prepare list of data point diffs
		List<Vector2> ddata = new List<Vector2>();
		for( int dpti = 1; dpti < data.Count; ++dpti )
		...
		controlPoints[controlPoints.Count-1] = controlPoints[controlPoints.Count-1]*2f - controlPoints[controlPoints.Count-2];
	}
}
